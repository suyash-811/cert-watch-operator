...
*/}}
{{- define "cert-watch-operator.name" -}}
...
*/}}
{{- define "cert-watch-operator.fullname" -}}
...
*/}}
{{- define "cert-watch-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "cert-watch-operator.resourceName" -}}
{{- $fullname := include "cert-watch-operator.fullname" .context }}
{{- $suffix := .suffix }}
